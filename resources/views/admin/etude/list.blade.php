                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/etude/edit/'.$item->id) }}" class="">Modifier</a>
...
<script>
    ...
    function deleteit(id){
        document.getElementById('del').action = '/etude/delete/'+id
    }
</script>
