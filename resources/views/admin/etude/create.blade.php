            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Créer une étude</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ url('/etude/create') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a id="filepreview" style="margin-top: 10px; display:block;" href="#" target="__blink">Aperçu du fichier</a>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <a id="demopreview" style="margin-top: 10px; display:block;" href="#" target="__blink">Aperçu du fichier</a>
                                        </div>
                                        <div class="form-group">
