...
@section('title')
    Modifier une étude | Bet Advisory
@endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Modifier une étude</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ url('/etude/edit/'.$etude->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="">
                                        <div class="form-group">
                                            ...
                                            <img id="coverpreview" src="{{ url($etude->cover) }}" style="width: 100px; height: 70px; margin-top:10px; object-fit: cover;" alt="">
                                        </div>
                                        <div class="form-group">
                                            <label for="title">Titre</label>
                                            <input type="text" id="title" class="form-control"
                                                placeholder="Titre de l'étude" value="{{ $etude->title }}" name="title">
                                        </div>
                                        <div class="form-group">
                                            <label for="prix">Prix</label>
                                            <input type="number" id="prix" class="form-control"
                                                placeholder="Prix de l'étude" value="{{ $etude->prix }}" name="prix">
                                        </div>
                                        <div class="form-group">
                                            <label for="category">Catégorie</label>
                                            <select id="category" class="form-select" name="category_id">
                                                @foreach($categories as $item)
                                                    @if($item->id == $etude->category_id)
                                        ...
                                        <div class="form-group">
                                            <label>Produit (fichier pdf)</label>
                                            <label for="file" class="label">Sélectionner un fichier</label>
                                            <input type="file" id="file" class="file" name="file">
                                            <a id="filepreview" style="margin-top: 10px; display:block;" href="{{ url($etude->file) }}" target="__blink">Aperçu du fichier</a>
                                        </div>
                                        <div class="form-group">
                                            <label>Fichier de démonstration</label>
                                            <label for="demo" class="label">Sélectionner un fichier</label>
                                            <input type="file" id="demo" class="file" name="demo">
                                            <a id="demopreview" style="margin-top: 10px; display:block;" href="{{ url($etude->demo ?? '#')  }}" target="__blink">Aperçu du fichier</a>
                                        </div>
                                        <div class="form-group">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('file').addEventListener('change', function () {
            ...
            if (file) {
                ...
                document.getElementById('filepreview').href = objectURL;
            }
        });
        ...
        document.getElementById('demo').addEventListener('change', function () {
            ...
            if (file) {
                ...
                document.getElementById('demopreview').href = objectURL;
            }
        });
    });
